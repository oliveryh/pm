...
- A communal space (e.g. couch or dining table)
- Space to keep a bike and equipment
- Food recycling facilities
- More than one toilet (multiple occupancy)
- Space to do basic calisthenics
- Area to work from home
- Gas hobs
- Dining room table
...
- Creating an account on SpareRoom
    ...
    - Express some flexibility and demonstrate your interests
- Go into estate agents (whole rent)
    - Going to the estate agent in person will allow you to create better relationship of requirements
    - Allows you to negotiate discounts

Things that didn't really amount to anything:
- Attending the speed house-mating event
    - The selection was too varied for my requirements
- Using apps such as MoveBubble or Badi
- Looking on Facebook
...
Senior Consultant
020 3814 8199
[shaun.datngarm@keatons.com](mailto:shaun.datngarm@keatons.com)


# Timeline

##  2019-09-03  - Viewed Property

- No particular appetite for offers
- 1 week holding fee
- Currently waiting to determine if it is furnished or not
    - Has nice furniture
- Back access for bike
- Small dining room table (Good enough :) )

##  2019-09-05  - Made an Offer

- Made an offer of £1325 p/m
- 2 Year Term
- 1 Year Break Clause
- Move in on the  2019-01-11

##  2019-09-06  - Furniture Information

- £800 Sofa (Need to check quality/make)
- £50 Bed Frame (Double Matress not included)
- £50 Table (If it belongs to the tenants)
- * Chairs not included
