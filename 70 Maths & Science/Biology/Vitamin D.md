...
Regulates calcium and phosphorus and influences over 200 genes

## Availability

Vitamin D levels in the UK fluctuate by 50% over the year

Although excessive sunlight is definitely harmful, it appears that the same goes for insufficient exposure to sunlight. There is research that shows that for Swedish women, avoidance of sunlight is associated with the same risks as smoking, for example.
