...
- [ ] Explore network and available opportunities
    - [ ] Who works where
    - [ ] Warm leads
    - [ ] Career opportunities outside London
    - [ ] Careers for software or people I admire (Pydantic, Linear etc.)
        - [ ] [https://www.granola.ai/](https://www.granola.ai/) “Trusted By” could inform list
...
- [x] Update LinkedIn
- [ ] Ensure CV is ATS optimised
- [x] Apply to Count Co role
- [x] Ensure laptop is no longer owned by Piclo
- [ ] List out current constraints about my search
- [ ] Add LinkedIn and GitHub to CV
- [ ] LinkedIn endorcements
- [x] Verify LinkedIn profile
- [ ] Apply for Job Seekers Allowance
- [ ] Extract pay-checks from Deel and update Google Sheets
- [ ] Mention SQS on CV
