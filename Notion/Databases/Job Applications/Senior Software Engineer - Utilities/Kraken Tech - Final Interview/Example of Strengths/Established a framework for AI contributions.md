...
Impact: Medium
Quick Summary: |-
  - C: Agentic AI use increasing
  - C: Team overwhelmed with PRs not following conventions
  - A: Empathised with frustration that you can’t just “Fix it”
  - A: 1:1 to those affected, improved their set up
  - A: Developed framework with engineers to embrace this form of contribution
  - A: Continual review sessions
  - R: Increased adoption of AI written code and positive feedback from CTO
  - R: Faster improvement of Copilot
Status: Done
Signal Areas:
  - Feedback / Conflict
---
...
- **Empowerment** - I met with the other engineers to develop a framework for us to sustainably take on issues that were entirely AI driven, and have time to review
- 🚩Spoke with our CTO to get his perspective, as adoption of AI often came with a significant amount of concern from engineers (Could be perceived as corporate / top-down)
