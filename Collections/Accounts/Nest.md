...
```mermaid
xychart-beta
    title "Cumulative Contributions vs Net Investment Returns"
    x-axis ["2021/22", "2022/23", "2023/24", "2024/25", "2025/26"]
    y-axis "£" -500 --> 16000
    line [2311, 5930, 9453, 12975, 15186]
    line [-44, -184, 854, 1457, 3848]
```
...
```mermaid
xychart-beta
    title "Projected Pension Pot to Retirement (Age 68, 2063)"
    x-axis ["2026", "2031", "2036", "2041", "2046", "2051", "2056", "2061", "2063"]
    y-axis "£ (thousands)" 0 --> 350
    line [19, 23, 28, 34, 42, 51, 62, 75, 81]
    line [19, 25, 34, 46, 61, 82, 109, 146, 164]
    line [19, 28, 41, 60, 89, 130, 191, 281, 328]
```
...
- [ ] Check with Finance team if I need to complete a Self Assessment to claim the tax relief on earnings taxable at 40% during the time we had a “Relief at Source” pension (ending 21/22 tax year)
    - The heading “Claiming Tax Relief Yourself” on [this page](https://www.gov.uk/tax-on-your-private-pension/pension-tax-relief) appears to allude to the possibility I need to submit this self-assessment.
