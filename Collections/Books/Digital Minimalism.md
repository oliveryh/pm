...
Attention Resistance:
	A loosely organized movement of individuals who use high-tech tools and strict operating procedures to extract value from the products of the digital attention economy, while avoiding falling victim to compulsive use.

## Chapter 1

What makes us uncomfortable about the use of technology is its affect on our daily lives and ability to act autonomously.

For example think about the following:
- Tuning out with our phone during our child’s bath time
- Losing our ability to enjoy a nice moment without a frantic urge to document it for a virtual audience.

Our attention is now being exploited for revenue, therefore companies don't respect users' attention.
...
Receiving a like is deeply rooted in our desire to be validated by our tribes, the difference now is that unlike Neolithic times, our survival doesn't depend on it.

## Chapter 2

The key difference that a digital minimalist has over others in general is that if a new technology offers little more than a minor diversion or trivial convenience, they'll ignore it. Even when a new technology promises to support something the minimalist values, it must still pass a stricter test: Is this the best way to use technology to support this value? If the answer is no, the minimalist will set to work trying to optimize the tech, or search out a better option.
...
We need to satisfy our desires in a controlled way that doesn't overwhelm us.

The average Facebook user, uses the company’s products a little over fifty minutes per day, it is likely that people can satisfy the key requirements of the platform in 30m a week as opposed to 3.5 hours.

Think about the following principles:

- Cluttering time and attention with too many devices/apps/services has an overall negative cost
- Optimizing a technology to extract the benefit and remove additional noise
- Satisfaction of the minimalist movement comes from intentionality and patience

### Cluttering Time and Attention

Henry David Thoreau wrote a book called Walden. He created a set of tables calculating the costs required to support his life at Walden Pond—a lifestyle that, as he argues at length in this first chapter, satisfies all the basic human needs: food, shelter, warmth, and so on. Thoreau then contrasts these costs with the hourly wages he could earn with his labor to arrive at the final value he cared most about: How much of his time must be sacrificed to support his minimalist lifestyle?

Another similar phrase that comes to mind here

> *“We buy things we don't need with money we don't have to impress people we don't like.”* - David Ramsey

Therou instead focusing purely on monetary value, as Frédéric Gros calls Thoreau’s “new economics,” he built upon the desire to value time as opposed to money.
...
Standard economic theory focuses on monetary outcomes. If working one acre of land as a farmer earns you $1 a year in profit, and working sixty acres earns you $60, then you should, if it’s at all possible, work the sixty acres—it produces strictly more money. While these farmers may have nicer finishing on their furniture, they may not have time to spend with their family, and increased stress from working so many hours.

It’s true that it takes more time to walk to town than to ride in a wagon, Thoreau notes, but these walks still likely require less time than the extra work hours needed to afford the wagon, and perhaps the walk itself offers other benefits.
...
A digital detox is largely focussed on new technologies, the ones that primary value are delivered through a digital screen.

We can ask ourselves a set of questions when considering a new technology, does it:
...
This is especially important when reintroducing technologies after the digital detox
...
The poet and essayist May Sarton explored the strangeness of this point in a 1972 diary entry, writing: I am here alone for the first time in weeks, to take up my “real” life again at last.21 That is what is strange—that friends, even passionate love, are not my real life unless there is time alone in which to explore and to discover what is happening or has happened. Without the interruptions, nourishing and maddening, this life would become arid. Yet I taste it fully only when I am alone.
...
In 90 percent of your daily life, the presence of a cell phone either doesn’t matter or makes things only slightly more convenient. They’re useful, but it’s hyperbolic to believe its ubiquitous presence is needed.

### Walking

> *“Only thoughts reached by walking have value.”* - Friedrich Nietzsche

Walking is aa fantastic source of solitude
...
Conversation includes nuanced analog cues such as the tone of voice or facial expression and this form of communication develops a relationship.
...
Playing games also provides permission for what we can call supercharged socializing—interactions with higher intensity levels than are common in polite society. Therefore through things such as play, we can reach a level of social interaction we couldn't hope to reach in everyday life.

**Leisure Lesson #3: Seek activities that require real-world, structured social interactions**

There is value in being able to fix and maintain our possessions, tapping into our strong instinct to manipulate objects in the physical world.

**Practice: Schedule Your Low-Quality Leisure**

Time-boxing low-quality leisure time will restrict its influence on the time your high-quality activities could take up instead.

Abstaning from low-quality activities will build up too many exceptions that will eventually cause you to undermind your determination and stop. By having some restricted use, we remove this risk.

**Practice: Join Something**

Integrating with the community is important.
...
Doing nothing is underrated, and while it is a tempting thought, we often digress to just taking part in low-quality activities. For the many different reasons argued in the preceding pages, investing energy into something hard but worthwhile almost always returns much richer rewards.

## Chapter 7

- Make your devices single purpose, reducing the possibility to switch from a purpose built tool (IDE), to a largely distraction driven place (Reddit)
- Use the Dunbar Number of 150—a theoretical limit for the number of people a human can successfully keep track of in their social circles
- Embrace Slow Media - focussing on the long reads as opposed to the breaking news
- Read articles in a space that is free from distraction
