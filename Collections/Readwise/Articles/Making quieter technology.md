...
- Category: #articles
- Summary: I spent the last years making technology calm and pleasant to use. This is roughly how I did it.
...
- A good operating system: Mac OS. Windows has become so user-hostile that I refuse to get near it. Linux breaks the rule above: a person's primary task should not be computing, but being human. ([View Highlight](https://read.readwise.io/read/01gzeqbh528vjs5v6gh6c08936))
- I also maintain a "things I don't understand" list. I pluck items from it once in a while, and queue up a few articles about them. They're nice bite-sized chunks of entertainment. ([View Highlight](https://read.readwise.io/read/01gzeqgnb632v1gw505259zcd7))
