...
- Category: #articles
- Summary: Single-Threaded Leaders at Amazon
- URL: https://pedrodelgallego.github.io/blog/amazon/single-threaded-model/

## Full Document
[[Full Document Contents/Articles/Single-Threaded Leaders at Amazon.md|See full document content →]]

## Highlights
- all success and failures rest with the leader, and the bucket stops there. ([View Highlight](https://read.readwise.io/read/01h3z98f0by1hq64ez4hx86q3y))
- A single-threaded leader is an individual wholly dedicated to solving one business problem, someone who wakes up in the morning and worries just about that one thing, ensuring the initiative’s vision and goals are always at the forefront and is ready to escalate risks early. ([View Highlight](https://read.readwise.io/read/01h3z992nkkn036s1qja5xxjsh))
- The best way to fail at inventing something is by making it somebody’s part-time job ([View Highlight](https://read.readwise.io/read/01h3z99yesq4rqdb2cvdetgzkf))
- In organizations where every decision is reviewed at multiple levels, there is little incentive to think deeply about a problem, and teams will rely on managers as safety gates, reducing the team ownership of the product. Furthermore, since the team is directly connected to the outcome of their decisions, it creates a powerful feedback loop, improving the team’s decision-making skills. ([View Highlight](https://read.readwise.io/read/01h3z9gbrm55sq0s25trcm39z2))
- It’s hard for teams to be deep in what customers care about in multiple areas. It’s also hard to spend enough time on the new initiatives when there’s resource contention with the more mature businesses ([View Highlight](https://read.readwise.io/read/01h3z9nwdg5p7hfkjd7dkrv6nf))
