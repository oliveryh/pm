...
![rw-book-cover](https://olano.dev/assets/img/readrun.png)
...
- Category: #articles
- Summary: Code is read more than written, code is run more than read. I think this line of thought can be extended beyond code-writing, and used as a rule of thumb to identify problems and make decisions.
- URL: https://olano.dev/2023-11-30-code-is-run-more-than-read/

## Full Document

[[Full Document Contents/Articles/Code Is Run More Than Read.md|See full document content →]]

## Highlights

- As Dan McKinley [puts it](https://mcfunley.com/choose-boring-technology):
