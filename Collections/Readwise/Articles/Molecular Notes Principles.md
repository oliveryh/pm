...
- Category: #articles
- Summary: In this post I present Molecular Notes, a note-taking system I created to help me learn from diverse sources (books, textbooks, articles, courses), distil insights, and synthesise new ideas.
...
- my mental model is that Sources (especially books) are typically composed of:
  ...
  • Thesis: the author gives their commentary/explanation regarding how concepts link to other concepts. ([View Highlight](https://read.readwise.io/read/01gwg0e7ef5d32beqakb1pas93))
