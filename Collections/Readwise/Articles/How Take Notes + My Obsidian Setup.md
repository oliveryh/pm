...
![rw-book-cover](https://sebastiandedeyne.com/img/og.png)
...
[[Full Document Contents/Articles/How Take Notes + My Obsidian Setup.md|See full document content →]]

## Highlights

- Most notes have two sections separated by a horizontal rule. The first section acts as a scratchpad and is in constant movement. The second section is a chronologically ordered log. ([View Highlight](https://read.readwise.io/read/01j70xx64v0wnv1tx78njr685p))
